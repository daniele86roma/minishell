...
BLT     = builtin/envp_utils.c builtin/pwd_utils.c builtin/exit_utils.c builtin/our_echo.c builtin/our_cd.c builtin/export_utils.c builtin/export_utils2.c builtin/unset_utils.c 
