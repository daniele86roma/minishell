...
PRS		= parse/parse.c parse/matrix.c parse/parse_utils.c parse/check.c parse/matrix2.c
ARG     = args/args_utils.c args/args.c args/sost_arg.c args/args_utils2.c
PIP		= pipex/pipex_utils.c pipex/pipex.c pipex/error.c pipex/check_file.c pipex/command_list.c pipex/exe_builtin.c pipex/in_redirect.c pipex/ambient.c
SIG		= signal/signal.c
OBJ		= ${SRC:.c=.o}
LFT		= libft/libft.a
